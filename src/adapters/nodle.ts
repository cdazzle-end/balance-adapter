...
export const nodleRouteConfigs = createRouteConfigs("nodle", [

  ]);

export const nodleTokensConfig: Record<string, BasicToken> = {
  NODL: {
    name: "NODL",
    symbol: "NODL",
    decimals: 11,
...
class NodleBalanceAdapter extends BalanceAdapter {
...
class BaseNodleAdapter extends BaseCrossChainAdapter {
  private balanceAdapter?: NodleBalanceAdapter;
  ...
  public async init(api: AnyApi) {
    ...
    this.balanceAdapter = new NodleBalanceAdapter({
...
export class NodleAdapter extends BaseNodleAdapter {
  constructor() {
    super(chains.nodle, nodleRouteConfigs, nodleTokensConfig);
  }
}